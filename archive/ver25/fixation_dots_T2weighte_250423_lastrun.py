...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\yiwei\\1_Pilot_MREye_Data\\1_anatomical-Protocol\\MREye_psychopy\\MREye_psychopy\\ver25\\fixation_dots_T2weighted.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisT1w_LIBRE in T1w_LIBRE:
        ...
        while continueRoutine and routineTimer.getTime() < 10.0:
            ...
            if dot_1.status == STARTED:
                ...
                if tThisFlipGlobal > dot_1.tStartRefresh + 1-frameTolerance:
    ...
    # completed 111.0 repeats of 'T1w_LIBRE'
